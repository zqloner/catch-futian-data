...
public class CarGoldenDragonNumberDict implements Serializable {
     ...
     * 车牌号
     */
    @ExcelColumn(value = "车牌号")
    private String carNum;

    /**
     * 车号
     */
    @ExcelColumn(value = "车号")
    private String carNo;

    /**
     * 终端编号
     */
    @ExcelColumn(value = "终端编号")
    private String carTerminalNum;

    /**
     * VIN
     */
    @ExcelColumn(value = "VIN")
    private String carVin;

    /**
     * 车型
     */
    @ExcelColumn(value = "车型")
    private String carType;

    /**
     * 里程(公里）
     */
    @ExcelColumn(value = "里程(公里）")
    private String carMileage;

    /**
     * 订单客户
     */
    @ExcelColumn(value = "订单客户")
    private String carCustomerClient;

    /**
     * 上报时间
     */
    @ExcelColumn(value = "上报时间")
    private String carReportDate;

    /**
     * 最后位置
     */
    @ExcelColumn(value = "最后位置")
